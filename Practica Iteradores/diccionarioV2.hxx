...
typename diccionario<K,D>::iterator		diccionario<K,D>::find( const K & s) const{
  typename diccionario<K,D>::iterator 	salida;
...
template <typename K, typename D>
diccionario<K,D>::iterator::iterator(typename diccionario<K,D>::entrada * p_e) {
...
template <typename K, typename D>
diccionario<K,D>::iterator::iterator(typename vector<pair<K,D> >::iterator itv) {
  
}


template <typename K, typename D>
 typename diccionario<K,D>::entrada & diccionario<K,D>::iterator::operator*() const {
 return *it_v;
}
...
template <typename K, typename D>
diccionario<K,D>::const_iterator::const_iterator(const const_iterator & it){
